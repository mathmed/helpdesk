		...
		public function sendEmail($vetor, $id_chamado, $tipo, $descricao){
			...
			if($tipo == 1){
				...
				<div style = 'margin-top:30px;'>
					...
					<text style = 'font-size 16px;'> foi adicionado no chamado #$id_chamado, para vizualizá-lo </text> <a href = 'http://process.servehttp.com/helpdesk'> Clique aqui </a>.
				</div>
				...
				<div style = 'margin-top:30px;'>
					...
					<text style = 'font-size 16px;'>Foi adicionado ao sistema, para vizualizá-lo </text> <a href = 'http://process.servehttp.com/helpdesk'> Clique aqui </a>.
				</div>
				...
				<div style = 'margin-top:30px;'>
					...
					<text style = 'font-size 16px;'>Id: #$id_chamado, para vizualizá-lo </text> <a href = 'http://process.servehttp.com/helpdesk'> Clique aqui </a>.
				</div>
				...
				<div style = 'margin-top:30px;'>
					...
					<text style = 'font-size 16px;'>Para acessar o sistema </text> <a href = 'http://process.servehttp.com/helpdesk'> Clique aqui </a>.
				</div>
			...
			public function sendEmailAtraso($vetor){
				...
				$msg = 
					...
					<div style='width=945px; height=1417px; border: 1px solid black; margin-top: 30px;'>
						...
						<a href='http://process.servehttp.com/helpdesk'>Clique aqui,</a> para acessar o sistema.<br/><br/>
